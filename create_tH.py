...
#  switchOn = ['21']
  ...
  for param in params:
    ...
    f_launchfile.write ('generate p p > h t j NP=1 NP^2==2\n')
    f_launchfile.write ('add process p p > h t~ j  NP=1 NP^2==2\n')
    f_launchfile.write ('add process p p > h t l- vl~  NP=1 NP^2==2\n')
    f_launchfile.write ('add process p p > h t~ l+ vl  NP=1 NP^2==2\n')
