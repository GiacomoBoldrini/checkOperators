...
#  switchOn = ['21']
  ...
  for param in params:
    ...
    f_launchfile.write ('generate g g > h NP=1 NP^2==2 SMHLOOP<=1\n')
    f_launchfile.write ('add process g g > h j NP=1 NP^2==2 SMHLOOP<=1\n')
    f_launchfile.write ('add process g g > h j j NP=1 NP^2==2 SMHLOOP<=1\n')
