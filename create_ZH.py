...
#  switchOn = ['21']
  ...
  for param in params:
    ...
    f_launchfile.write ('generate p p > h l+ l- NP=1 NP^2==2\n')
    f_launchfile.write ('add process p p > h vl vl~  NP=1 NP^2==2\n')
    f_launchfile.write ('add process p p > h l+ l- j   NP=1 NP^2==2\n')
    f_launchfile.write ('add process  p p > h vl vl~ j  NP=1 NP^2==2\n')
